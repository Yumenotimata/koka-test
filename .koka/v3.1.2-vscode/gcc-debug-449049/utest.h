...
static inline kk_std_core_hnd__clause1 kk_utest_test_case_fs__fun_test_case_fail(kk_utest__test_case _this, kk_context_t* _ctx) { /* forall<e,a> (test-case<e,a>) -> hnd/clause1<(string, string, string),(),test-case,e,a> */ 
  {
    struct kk_utest__Hnd_test_case* _con_x242 = kk_utest__as_Hnd_test_case(_this, _ctx);
    kk_std_core_hnd__clause1 _x = _con_x242->_fun_test_case_fail;
...
static inline kk_box_t kk_utest_test_failure_fs_expected(kk_utest__test_failure _this, kk_context_t* _ctx) { /* forall<a,b> (test-failure<a,b>) -> a */ 
  {
    ...
    kk_box_t _x = _con_x243->expected;
...
static inline kk_box_t kk_utest_test_failure_fs_actual(kk_utest__test_failure _this, kk_context_t* _ctx) { /* forall<a,b> (test-failure<a,b>) -> b */ 
  {
    struct kk_utest_TestFailure* _con_x244 = kk_utest__as_TestFailure(_this, _ctx);
    kk_box_t _x = _con_x244->actual;
    return kk_box_dup(_x, _ctx);
  }
}
...
static inline kk_integer_t kk_utest_test_suite_fs__cfc(kk_utest__test_suite _this, kk_context_t* _ctx) { /* forall<e,a> (test-suite<e,a>) -> int */ 
  {
    struct kk_utest__Hnd_test_suite* _con_x252 = kk_utest__as_Hnd_test_suite(_this, _ctx);
    kk_integer_t _x = _con_x252->_cfc;
    return kk_integer_dup(_x, _ctx);
  }
}
...
static inline kk_std_core_hnd__clause1 kk_utest_test_suite_fs__fun_test_suite_fail(kk_utest__test_suite _this, kk_context_t* _ctx) { /* forall<e,a> (test-suite<e,a>) -> hnd/clause1<(string, string, string),(),test-suite,e,a> */ 
  {
    struct kk_utest__Hnd_test_suite* _con_x253 = kk_utest__as_Hnd_test_suite(_this, _ctx);
    kk_std_core_hnd__clause1 _x = _con_x253->_fun_test_suite_fail;
    return kk_std_core_hnd__clause1_dup(_x, _ctx);
  }
}
...
static inline kk_std_core_hnd__clause2 kk_utest__select_test_fail(kk_utest__test hnd, kk_context_t* _ctx) { /* forall<e,a> (hnd : test<e,a>) -> hnd/clause2<string,string,(),test,e,a> */ 
  {
    struct kk_utest__Hnd_test* _con_x257 = kk_utest__as_Hnd_test(hnd, _ctx);
    kk_std_core_hnd__clause2 _fun_test_fail = _con_x257->_fun_test_fail;
...
static inline kk_unit_t kk_utest_test_fail(kk_string_t expected, kk_string_t actual, kk_context_t* _ctx) { /* (expected : string, actual : string) -> test () */ 
  kk_std_core_hnd__ev evx_10043 = kk_evv_at(((KK_IZ(0))),kk_context()); /*hnd/ev<utest/test>*/;
  kk_box_t _x_x258;
  {
    struct kk_std_core_hnd_Ev* _con_x259 = kk_std_core_hnd__as_Ev(evx_10043, _ctx);
    kk_box_t _box_x9 = _con_x259->hnd;
    int32_t m = _con_x259->marker;
    kk_utest__test h = kk_utest__test_unbox(_box_x9, KK_BORROWED, _ctx);
    kk_utest__test_dup(h, _ctx);
    {
      struct kk_utest__Hnd_test* _con_x260 = kk_utest__as_Hnd_test(h, _ctx);
      kk_integer_t _pat_0_0 = _con_x260->_cfc;
      kk_std_core_hnd__clause2 _fun_test_fail = _con_x260->_fun_test_fail;
      ...
      }
      {
        ...
        _x_x258 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_box_t, kk_context_t*), _fun_unbox_x14, (_fun_unbox_x14, m, evx_10043, kk_string_box(expected), kk_string_box(actual), _ctx), _ctx); /*1016*/
      }
    }
  }
  kk_unit_unbox(_x_x258); return kk_Unit;
}
...
static inline kk_std_core_hnd__clause1 kk_utest__select_test_case_fail(kk_utest__test_case hnd, kk_context_t* _ctx) { /* forall<e,a> (hnd : test-case<e,a>) -> hnd/clause1<(string, string, string),(),test-case,e,a> */ 
  {
    struct kk_utest__Hnd_test_case* _con_x264 = kk_utest__as_Hnd_test_case(hnd, _ctx);
    kk_std_core_hnd__clause1 _fun_test_case_fail = _con_x264->_fun_test_case_fail;
...
struct kk_utest_test_case_fail_fun266__t {
...
static inline kk_function_t kk_utest_new_test_case_fail_fun266(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_utest_test_case_fail_fun266, _ctx)
  return kk_function_dup(_fself,kk_context());
}


static inline kk_unit_t kk_utest_test_case_fail(kk_string_t test_name, kk_string_t expected, kk_string_t actual, kk_context_t* _ctx) { /* (test-name : string, expected : string, actual : string) -> test-case () */ 
  kk_std_core_hnd__ev _b_x27_33 = kk_evv_at(((KK_IZ(0))),kk_context()); /*hnd/ev<utest/test-case>*/;
  kk_box_t _x_x265 = kk_std_core_hnd__perform3(_b_x27_33, kk_utest_new_test_case_fail_fun266(_ctx), kk_string_box(test_name), kk_string_box(expected), kk_string_box(actual), _ctx); /*1003*/
...
static inline kk_std_core_hnd__clause1 kk_utest__select_test_suite_fail(kk_utest__test_suite hnd, kk_context_t* _ctx) { /* forall<e,a> (hnd : test-suite<e,a>) -> hnd/clause1<(string, string, string),(),test-suite,e,a> */ 
  {
    struct kk_utest__Hnd_test_suite* _con_x270 = kk_utest__as_Hnd_test_suite(hnd, _ctx);
    kk_std_core_hnd__clause1 _fun_test_suite_fail = _con_x270->_fun_test_suite_fail;
...
// lift anonymous function
struct kk_utest_test_suite_fail_fun272__t {
  struct kk_function_s _base;
};
extern kk_std_core_hnd__clause1 kk_utest_test_suite_fail_fun272(kk_function_t _fself, kk_box_t _b_x51, kk_context_t* _ctx);
static inline kk_function_t kk_utest_new_test_suite_fail_fun272(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_utest_test_suite_fail_fun272, _ctx)
  return kk_function_dup(_fself,kk_context());
}
...
static inline kk_unit_t kk_utest_test_suite_fail(kk_string_t suite_name, kk_string_t expected, kk_string_t actual, kk_context_t* _ctx) { /* (suite-name : string, expected : string, actual : string) -> test-suite () */ 
  kk_std_core_hnd__ev _b_x46_52 = kk_evv_at(((KK_IZ(0))),kk_context()); /*hnd/ev<utest/test-suite>*/;
  kk_box_t _x_x271 = kk_std_core_hnd__perform3(_b_x46_52, kk_utest_new_test_suite_fail_fun272(_ctx), kk_string_box(suite_name), kk_string_box(expected), kk_string_box(actual), _ctx); /*1003*/
  kk_unit_unbox(_x_x271); return kk_Unit;
}
