...
static inline kk_std_core_types__list kk_std_os_env_get_env(kk_context_t* _ctx) { /* () -> ndet env */ 
  kk_box_t _x_x82;
  kk_std_core_delayed__delayed _x_x83 = kk_std_core_delayed__delayed_dup(kk_std_os_env_environ, _ctx); /*delayed/delayed<ndet,std/os/env/env>*/
  _x_x82 = kk_std_core_delayed_force(_x_x83, _ctx); /*270*/
  return kk_std_core_types__list_unbox(_x_x82, KK_OWNED, _ctx);
}
...
static inline kk_std_core_types__list kk_std_os_env_get_argv(kk_context_t* _ctx) { /* () -> ndet list<string> */ 
  kk_box_t _x_x90;
  kk_std_core_delayed__delayed _x_x91 = kk_std_core_delayed__delayed_dup(kk_std_os_env_argv, _ctx); /*delayed/delayed<ndet,list<string>>*/
  _x_x90 = kk_std_core_delayed_force(_x_x91, _ctx); /*270*/
  return kk_std_core_types__list_unbox(_x_x90, KK_OWNED, _ctx);
}
