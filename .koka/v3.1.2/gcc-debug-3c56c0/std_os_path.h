...
static inline kk_unit_t kk_std_os_path__mlift_proot_10192(kk_std_core_types__list _y_x10143, kk_context_t* _ctx) { /* (list<char>) -> std/text/parse/parse () */ 
  kk_std_core_types__list_drop(_y_x10143, _ctx);
  kk_Unit; return kk_Unit;
}
...
static inline kk_std_os_path__path kk_std_os_path__create_Path(kk_std_core_types__optional root, kk_std_core_types__optional parts, kk_context_t* _ctx) { /* (root : ? string, parts : ? (list<string>)) -> path */ 
  ...
  if (kk_std_core_types__is_Optional(root, _ctx)) {
    kk_box_t _box_x59 = root._cons._Optional.value;
    kk_string_t _uniq_root_447 = kk_string_unbox(_box_x59);
    kk_string_dup(_uniq_root_447, _ctx);
    kk_std_core_types__optional_drop(root, _ctx);
    _x_x595 = _uniq_root_447; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(root, _ctx);
    _x_x595 = kk_string_empty(); /*string*/
  }
  kk_std_core_types__list _x_x597;
  if (kk_std_core_types__is_Optional(parts, _ctx)) {
    kk_box_t _box_x60 = parts._cons._Optional.value;
    kk_std_core_types__list _uniq_parts_453 = kk_std_core_types__list_unbox(_box_x60, KK_BORROWED, _ctx);
    kk_std_core_types__list_dup(_uniq_parts_453, _ctx);
    kk_std_core_types__optional_drop(parts, _ctx);
    _x_x597 = _uniq_parts_453; /*list<string>*/
  }
  else {
    kk_std_core_types__optional_drop(parts, _ctx);
    _x_x597 = kk_std_core_types__new_Nil(_ctx); /*list<string>*/
  }
  return kk_std_os_path__new_Path(_x_x595, _x_x597, _ctx);
}
...
static inline kk_string_t kk_std_os_path_show(kk_std_os_path__path p, kk_context_t* _ctx) { /* (p : path) -> string */ 
  kk_string_t _x_x680 = kk_std_os_path_string(p, _ctx); /*string*/
  return kk_std_core_show_string_fs_show(_x_x680, _ctx);
}
...
static inline bool kk_std_os_path_is_relative(kk_std_os_path__path p, kk_context_t* _ctx) { /* (p : path) -> bool */ 
  ...
  kk_string_t _x_x682 = kk_string_empty(); /*string*/
  return kk_string_is_eq(_x_x681,_x_x682,kk_context());
}
...
static inline bool kk_std_os_path_is_absolute(kk_std_os_path__path p, kk_context_t* _ctx) { /* (p : path) -> bool */ 
  ...
  kk_string_t _x_x685 = kk_string_empty(); /*string*/
  b_10043 = kk_string_is_eq(_x_x684,_x_x685,kk_context()); /*bool*/
  if (b_10043) {
    return false;
  }
  {
...
static inline kk_std_core_types__list kk_std_os_path_paths(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> list<path> */ 
  ...
  kk_string_t _x_x715;
  kk_define_string_literal(, _s_x716, 1, ":", _ctx)
  _x_x715 = kk_string_dup(_s_x716, _ctx); /*string*/
  s_0_10052 = kk_string_replace_all(s,_x_x713,_x_x715,kk_context()); /*string*/
  kk_vector_t v_10013;
  kk_string_t _x_x717;
  kk_define_string_literal(, _s_x718, 1, ":", _ctx)
  _x_x717 = kk_string_dup(_s_x718, _ctx); /*string*/
  v_10013 = kk_string_splitv(s_0_10052,_x_x717,kk_context()); /*vector<string>*/
  kk_std_core_types__list _x_x719 = kk_std_core_vector_vlist(v_10013, kk_std_core_types__new_None(_ctx), _ctx); /*list<795>*/
  return kk_std_os_path_paths_collect(_x_x719, _ctx);
}
...
static inline kk_std_os_path__path kk_std_os_path_noext(kk_std_os_path__path p, kk_context_t* _ctx) { /* (p : path) -> path */ 
  ...
  return kk_std_os_path_change_ext(p, _x_x783, _ctx);
}
...
static inline kk_std_core_types__list kk_std_os_path_dirparts(kk_std_os_path__path p, kk_context_t* _ctx) { /* (p : path) -> list<string> */ 
  kk_std_core_types__list _x_x840;
  {
    ...
    kk_std_os_path__path_drop(p, _ctx);
    _x_x840 = _x; /*list<string>*/
  }
  return kk_std_core_list__lift_reverse_append_4948(kk_std_core_types__new_Nil(_ctx), _x_x840, _ctx);
}
