...
kk_std_core_types__list kk_std_os_env__trmc_to_tuples(kk_std_core_types__list xs, kk_std_core_types__cctx _acc, kk_context_t* _ctx) { /* (xs : list<string>, ctx<env>) -> env */ 
  ...
  if (kk_std_core_types__is_Cons(xs, _ctx)) {
    struct kk_std_core_types_Cons* _con_x63 = kk_std_core_types__as_Cons(xs, _ctx);
    kk_box_t _box_x0 = _con_x63->head;
    kk_std_core_types__list _pat_0 = _con_x63->tail;
    if (kk_std_core_types__is_Cons(_pat_0, _ctx)) {
      struct kk_std_core_types_Cons* _con_x64 = kk_std_core_types__as_Cons(_pat_0, _ctx);
      kk_box_t _box_x1 = _con_x64->head;
      kk_string_t name = kk_string_unbox(_box_x0);
      kk_std_core_types__list xx = _con_x64->tail;
      ...
      kk_box_t _x_x65;
      kk_std_core_types__tuple2 _x_x66 = kk_std_core_types__new_Tuple2(kk_string_box(name), kk_string_box(value), _ctx); /*(129, 130)*/
      _x_x65 = kk_std_core_types__tuple2_box(_x_x66, _ctx); /*1169*/
      _trmc_x10003 = kk_std_core_types__new_Cons(_ru_x60, 0, _x_x65, _trmc_x10002, _ctx); /*list<(string, string)>*/
      kk_field_addr_t _b_x15_27 = kk_field_addr_create(&kk_std_core_types__as_Cons(_trmc_x10003, _ctx)->tail, _ctx); /*@field-addr<std/os/env/env>*/;
      { // tailcall
        kk_std_core_types__cctx _x_x67 = kk_cctx_extend_linear(_acc,(kk_std_core_types__list_box(_trmc_x10003, _ctx)),_b_x15_27,kk_context()); /*ctx<0>*/
        xs = xx;
        _acc = _x_x67;
        goto kk__tailcall;
      }
  ...
  if (kk_std_core_types__is_Cons(xs, _ctx)) {
    struct kk_std_core_types_Cons* _con_x68 = kk_std_core_types__as_Cons(xs, _ctx);
    kk_box_t _box_x16 = _con_x68->head;
    kk_std_core_types__list _pat_2 = _con_x68->tail;
    ...
    kk_box_t _x_x69;
    kk_box_t _x_x70;
    kk_std_core_types__list _x_x71;
    kk_box_t _x_x72;
    kk_std_core_types__tuple2 _x_x73;
    kk_box_t _x_x74;
    kk_string_t _x_x75 = kk_string_empty(); /*string*/
    _x_x74 = kk_string_box(_x_x75); /*130*/
    _x_x73 = kk_std_core_types__new_Tuple2(kk_string_box(name_0), _x_x74, _ctx); /*(129, 130)*/
    _x_x72 = kk_std_core_types__tuple2_box(_x_x73, _ctx); /*1193*/
    _x_x71 = kk_std_core_types__new_Cons(_ru_x61, 0, _x_x72, kk_std_core_types__new_Nil(_ctx), _ctx); /*list<1193>*/
    _x_x70 = kk_std_core_types__list_box(_x_x71, _ctx); /*-1*/
    _x_x69 = kk_cctx_apply_linear(_acc,_x_x70,kk_context()); /*-1*/
    return kk_std_core_types__list_unbox(_x_x69, KK_OWNED, _ctx);
  }
  {
    kk_box_t _x_x77 = kk_cctx_apply_linear(_acc,(kk_std_core_types__list_box(kk_std_core_types__new_Nil(_ctx), _ctx)),kk_context()); /*-1*/
    return kk_std_core_types__list_unbox(_x_x77, KK_OWNED, _ctx);
  }
}

kk_std_core_types__list kk_std_os_env_to_tuples(kk_std_core_types__list xs_0, kk_context_t* _ctx) { /* (xs : list<string>) -> env */ 
  kk_std_core_types__cctx _x_x78 = kk_cctx_empty(kk_context()); /*ctx<0>*/
  return kk_std_os_env__trmc_to_tuples(xs_0, _x_x78, _ctx);
}
...
struct kk_std_os_env_environ_fun79__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_os_env_environ_fun79(kk_function_t _fself, kk_context_t* _ctx);
static kk_function_t kk_std_os_env_new_environ_fun79(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_os_env_environ_fun79, _ctx)
...
static kk_box_t kk_std_os_env_environ_fun79(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_std_core_types__list _x_x81 = kk_std_core_vector_vlist(v_10000, kk_std_core_types__new_None(_ctx), _ctx); /*list<795>*/
  _x_x80 = kk_std_os_env_to_tuples(_x_x81, _ctx); /*std/os/env/env*/
  return kk_std_core_types__list_box(_x_x80, _ctx);
}
...
// lift anonymous function
struct kk_std_os_env_get_env_value_fun86__t {
  struct kk_function_s _base;
  kk_string_t name;
};
static bool kk_std_os_env_get_env_value_fun86(kk_function_t _fself, kk_box_t _b_x46, kk_context_t* _ctx);
static kk_function_t kk_std_os_env_new_get_env_value_fun86(kk_string_t name, kk_context_t* _ctx) {
  struct kk_std_os_env_get_env_value_fun86__t* _self = kk_function_alloc_as(struct kk_std_os_env_get_env_value_fun86__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_os_env_get_env_value_fun86, kk_context());
  _self->name = name;
  return kk_datatype_from_base(&_self->_base, kk_context());
}

static bool kk_std_os_env_get_env_value_fun86(kk_function_t _fself, kk_box_t _b_x46, kk_context_t* _ctx) {
  struct kk_std_os_env_get_env_value_fun86__t* _self = kk_function_as(struct kk_std_os_env_get_env_value_fun86__t*, _fself, _ctx);
  kk_string_t name = _self->name; /* string */
  kk_drop_match(_self, {kk_string_dup(name, _ctx);}, {}, _ctx)
  kk_string_t _x_x87 = kk_string_unbox(_b_x46); /*string*/
  return kk_string_is_eq(_x_x87,name,kk_context());
}

kk_std_core_types__maybe kk_std_os_env_get_env_value(kk_string_t name, kk_context_t* _ctx) { /* (name : string) -> ndet maybe<string> */ 
  kk_std_core_types__list _b_x44_47;
  kk_box_t _x_x84;
  kk_std_core_delayed__delayed _x_x85 = kk_std_core_delayed__delayed_dup(kk_std_os_env_environ, _ctx); /*delayed/delayed<ndet,std/os/env/env>*/
  _x_x84 = kk_std_core_delayed_force(_x_x85, _ctx); /*270*/
  _b_x44_47 = kk_std_core_types__list_unbox(_x_x84, KK_OWNED, _ctx); /*std/os/env/env*/
  return kk_std_core_list_lookup(_b_x44_47, kk_std_os_env_new_get_env_value_fun86(name, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_os_env_argv_fun88__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_os_env_argv_fun88(kk_function_t _fself, kk_context_t* _ctx);
static kk_function_t kk_std_os_env_new_argv_fun88(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_os_env_argv_fun88, _ctx)
  return kk_function_dup(_fself,kk_context());
}

static kk_box_t kk_std_os_env_argv_fun88(kk_function_t _fself, kk_context_t* _ctx) {
  kk_unused(_fself);
  kk_vector_t v_10001 = kk_std_os_env_os_get_argv(_ctx); /*vector<string>*/;
  kk_std_core_types__list _x_x89 = kk_std_core_vector_vlist(v_10001, kk_std_core_types__new_None(_ctx), _ctx); /*list<795>*/
  return kk_std_core_types__list_box(_x_x89, _ctx);
}
...
kk_std_core_types__list kk_std_os_env_get_args(kk_context_t* _ctx) { /* () -> ndet list<string> */ 
  bool is_node;
  kk_string_t _x_x92 = kk_std_core_host(_ctx); /*string*/
  kk_string_t _x_x93;
  kk_define_string_literal(, _s_x94, 4, "node", _ctx)
  _x_x93 = kk_string_dup(_s_x94, _ctx); /*string*/
  is_node = kk_string_is_eq(_x_x92,_x_x93,kk_context()); /*bool*/
  kk_std_core_types__list _match_x58;
  kk_box_t _x_x95;
  kk_std_core_delayed__delayed _x_x96 = kk_std_core_delayed__delayed_dup(kk_std_os_env_argv, _ctx); /*delayed/delayed<ndet,list<string>>*/
  _x_x95 = kk_std_core_delayed_force(_x_x96, _ctx); /*270*/
  _match_x58 = kk_std_core_types__list_unbox(_x_x95, KK_OWNED, _ctx); /*list<string>*/
  if (kk_std_core_types__is_Cons(_match_x58, _ctx)) {
    struct kk_std_core_types_Cons* _con_x97 = kk_std_core_types__as_Cons(_match_x58, _ctx);
    kk_box_t _box_x56 = _con_x97->head;
    kk_string_t x = kk_string_unbox(_box_x56);
    bool _x_x98;
    if (is_node) {
      kk_string_t _x_x99;
      kk_std_os_path__path _x_x100;
      kk_string_t _x_x101 = kk_string_dup(x, _ctx); /*string*/
      _x_x100 = kk_std_os_path_path(_x_x101, _ctx); /*std/os/path/path*/
      _x_x99 = kk_std_os_path_stemname(_x_x100, _ctx); /*string*/
      kk_string_t _x_x102;
      kk_define_string_literal(, _s_x103, 4, "node", _ctx)
      _x_x102 = kk_string_dup(_s_x103, _ctx); /*string*/
      _x_x98 = kk_string_is_eq(_x_x99,_x_x102,kk_context()); /*bool*/
    }
    else {
      _x_x98 = false; /*bool*/
    }
    if (_x_x98) {
      kk_std_core_types__list xx = _con_x97->tail;
...
void kk_std_os_env__init(kk_context_t* _ctx){
  ...
  #endif
  {
    kk_std_os_env_environ = kk_std_core_delayed_delay(kk_std_os_env_new_environ_fun79(_ctx), _ctx); /*delayed/delayed<ndet,std/os/env/env>*/
  }
  {
    kk_std_os_env_argv = kk_std_core_delayed_delay(kk_std_os_env_new_argv_fun88(_ctx), _ctx); /*delayed/delayed<ndet,list<string>>*/
  }
}
